...
const UserInformation = () => {
  ...
  return (
    <div className="w-full bg-white rounded-md px-4 py-3 lg:py-6 lg:px-8">
      <h4 className="mb-4 lg:mb-6">تکمیل اطلاعات کاربری</h4>
      <Formik
      ...
      >
        <Form className="flex flex-col gap-y-8 lg:grid lg:grid-cols-2 lg:gap-16 lg:py-6">
          <FormInput text="نام" type="text" name="firstName" required />
          <FormInput text="نام خانوادگی" type="text" name="lastName" required />
          <FormInput text="ایمیل" type="email" name="email" />
          <FormInput text="کد ملی" type="number" name="nationalCode" required />
          ...
          <button
            className="bg-blue text-white text-[14px] flex items-center justify-center h-10 rounded-[5px] sm:w-1/2 lg:col-start-2 lg:justify-self-end"
            type="submit"
          >
            تایید و ادامه
          </button>
